...
class RerentRoomReserve extends StatefulWidget {
  final String? token;

  const RerentRoomReserve({super.key, this.token});

  @override
  State<RerentRoomReserve> createState() =>
      _RerentRoomReserveState();
}

class _RerentRoomReserveState extends State<RerentRoomReserve> {
  ...
  void initState() {
    ...
    super.initState();
    DateTime checkInDate = selectedDateCheckInRerent!;
                                        ...
                                        try {
                                          ...
                                          await FirebaseFirestore
                                            ...
                                            try {
                                              ...
                                              String body =
                                                  'Someone wants to Re-rent or reserve a room, check it now!';
                                              await FirebaseFirestore
                                                  .instance
                                                  .collection(
                                                  'Reservations')
                                              ...
                                              await FirebaseFirestore
                                                ...
                                                DateTime.now(),
                                                'message':
                                                '$fName $mName $lName want to reserve or Re-rent Room $roomNumber',
                                                'status': true
                                              });
                                              sendPushMessage(
                                                  body, title);
                                              QuickAlert.show(
                                                ...
                                                type: QuickAlertType
                                                    .success,
                                                title:
                                                'Re-rent Room successfully reserve!',
                                                text:
