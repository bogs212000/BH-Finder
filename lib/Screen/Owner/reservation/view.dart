...
class OwnerViewReservationScreen extends StatefulWidget {
  final String? token;
  final String? bName;

  const OwnerViewReservationScreen({Key? key, this.token, this.bName})
      : super(key: key);

  @override
  State<OwnerViewReservationScreen> createState() => _OwnerViewReservationScreenState();
}

class _OwnerViewReservationScreenState extends State<OwnerViewReservationScreen> {
                  ...
                  userRole != 'Owner'
                    ...
                    children: [
                      ...
                      if (data['status'] == 'rejected')
                        'Reservations has been rejected'.text.make(),
                    ],
                  ),
                ],
              ),
